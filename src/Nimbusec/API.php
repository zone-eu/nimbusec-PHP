...
class API {
     ...
     * @throws Nimbusec\Exception When an error occurs during JSON encoding / decoding; <br/>Contains the <b>JSON error message</b>.
    ...
    function createDomain ( $domain ) {
        ...
        if ( !empty ( $err ) )
            throw new Exception ( "JSON: an error ocurred '{$err}' while encoding" );
     ...
     * @throws Nimbusec\Exception When an error occurs during JSON encoding / decoding process; <br/>Contains the <b>JSON error message</b>.
